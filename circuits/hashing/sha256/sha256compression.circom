// One block (512 bits) SHA-256 compression (FIPS 180-4).
pragma circom 2.0.0;
...
include "compression_function.circom";
...
template Sha256compression() {
    ...
    for (k = 0; k < 32; k++) {
        fsum[0].in[0][k] <== hin[0*32 + k];
        fsum[0].in[1][k] <== a[64][k];
        fsum[1].in[0][k] <== hin[1*32 + k];
        fsum[1].in[1][k] <== b[64][k];
        fsum[2].in[0][k] <== hin[2*32 + k];
        fsum[2].in[1][k] <== c[64][k];
        fsum[3].in[0][k] <== hin[3*32 + k];
        fsum[3].in[1][k] <== d[64][k];
        fsum[4].in[0][k] <== hin[4*32 + k];
        fsum[4].in[1][k] <== e[64][k];
        fsum[5].in[0][k] <== hin[5*32 + k];
        fsum[5].in[1][k] <== f[64][k];
        fsum[6].in[0][k] <== hin[6*32 + k];
        fsum[6].in[1][k] <== g[64][k];
        fsum[7].in[0][k] <== hin[7*32 + k];
